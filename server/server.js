...
// This middleware will catch any unhandled errors that occur in the routing and middleware chain.
// It must be the last piece of middleware added to the app.
app.use((err, req, res, next) => {
  // Log the full error stack for debugging purposes on the server.
  console.error('Unhandled Exception:', err.stack);

  // Send a generic but informative error message to the client.
  // We avoid sending the full stack trace to the client for security reasons.

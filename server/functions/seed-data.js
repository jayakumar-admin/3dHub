...
const users = [
  { id: 'user1', name: 'Admin User', email: 'admin1@gmail.com', password: adminPasswordHash, avatar: fbUrl('3dHub/users/admin.png'), phone: '9876543210', role: 'Admin', joined_date: '2023-01-15'},
  { id: 'user2', name: 'Alice Johnson', email: 'alice.j@example.com', password: null, avatar: fbUrl('3dHub/users/user1.png'), phone: '9876543211', role: 'Customer', joined_date: '2024-03-10'},
  { id: 'user3', name: 'Bob Williams', email: 'bob.w@example.com', password: null, avatar: fbUrl('3dHub/users/user2.png'), phone: '9876543212', role: 'Customer', joined_date: '2024-05-02'},
  { id: 'user4', name: 'Charlie Brown', email: 'charlie.b@example.com', password: null, avatar: fbUrl('3dHub/users/user3.png'), phone: '9876543213', role: 'Customer', joined_date: '2024-06-20'},
];

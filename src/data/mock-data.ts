...
export const MOCK_USERS: User[] = [
  { id: 'user1', name: 'Admin User', email: 'admin1@gmail.com', avatar: fbUrl('3dHub/users/admin.png'), role: 'Admin', joinedDate: '2023-01-15', password: 'admin12345678' },
  { id: 'user2', name: 'Alice Johnson', email: 'alice.j@example.com', avatar: fbUrl('3dHub/users/user1.png'), role: 'Customer', joinedDate: '2024-03-10', password: 'password123' },
  { id: 'user3', name: 'Bob Williams', email: 'bob.w@example.com', avatar: fbUrl('3dHub/users/user2.png'), role: 'Customer', joinedDate: '2024-05-02', password: 'password123' },
  { id: 'user4', name: 'Charlie Brown', email: 'charlie.b@example.com', avatar: fbUrl('3dHub/users/user3.png'), role: 'Customer', joinedDate: '2024-06-20', password: 'password123' },
  { id: 'user5', name: 'Diana Prince', email: 'diana.p@example.com', avatar: fbUrl('3dHub/users/user4.png'), role: 'Customer', joinedDate: '2024-07-01', password: 'password123' },
];
